...
## [2026-06-20] 工作方式升级 — 三大核心标准

- **来源：** 用户反馈"很多时候我说不精确是因为我不知道"
- **学到了什么：**
  - 用户说不精确是因为不知道，不是偷懒
  - 我的职责是主动问对问题，帮用户理清需求
  - 多轮提问（2-3 个/轮），逐步收敛
  - 对结果负责，不是对执行动作负责
- **产出：**
  - 新增 `wiki/hermes-workstyle-upgrade.md`（Hermes 工作方式升级指南）
  - 新增 `lessons-learned.md` L20-L22（三条新经验）
  - 更新 `index.md`（新增工作方式分类）
  - 更新 `hot.md`
- **关键规则：**
