...
## [2026-06-13] 沙特外贸深度调研 — 河北石家庄→沙特出口全链路

- **来源：** 用户需求驱动（河北石家庄外贸选品）
- **学到了什么：** (1) 外贸选品核心公式 = 本地产能 ∩ 目标国需求。河北有丝网（安平）、纺织（石家庄）、钢铁（全省）、医药（石家庄），沙特最大需求是机械设备、钢铁建材、医药、纺织品。匹配度最高的是安平丝网和阿拉伯长袍。(2) 沙特 SABER 认证是最大门槛，42% 海关扣押因为缺 SABER 二维码。认证找 Intertek/Bureau Veritas，周期 10-14 天。(3) 沙特商务文化核心是 Wasta（关系），慢节奏、等级制、面对面，着急=不尊重。(4) 化妆品瓶主产区在广州/广东，不在河北——选品必须考虑产业带距离。(5) G7国家市场竞争激烈、合规门槛高，中小企业更适合"一带一路"沿线（沙特、阿联酋、哈萨克、越南、印尼）。
- **能力提升：** 建立了外贸选品分析框架（市场大盘→本地产能→交叉匹配→利润/门槛/风险→执行路线图），可复用到其他品类和目的地。
- **产出：** `wiki/saudi-trade-deep-dive.md`（沙特外贸深度指南，含认证、物流、文化、付款、风险、执行路线图 10 大模块）
- **下一步：** 如需落地执行，从安平丝网品类切入，做 SABER 认证 + 开发客户。
